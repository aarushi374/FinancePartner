...
<body>
	...
	<div class="admin_form">
		...
		<form action="MyServlet" method="post">
			<label class="login_text">Admin ID:</label><br> <input
				type="text" name="Admin_ID" class="input_login" required><br>
			<label class="login_text">Password:</label><br> <input
				type="password" name="adminlogin_password" class="input_login"
				required> <input type="submit" name="admin_login"
				class="btn_login">
		</form>
	</div>
	<div class="footer">
