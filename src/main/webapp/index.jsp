...
<nav>
    ...
    <button class="btn_admin" onclick="location.href = './admin.jsp';"><i class="fas fa-user-shield"></i>Admin</button>
    </nav>
    <div class="slideshow">
    ...
    <div class="login_form">
      ...
      <label class="login_text">Customer ID:</label><br>
      <input type="number" name="Customer_ID" class="input_login" required><br>
      <label class="login_text">Password</label><br>
      <input type="password" name="login_password" class="input_login" required>
    ...
    <button class="btn_login" onclick="location.href = './signup.jsp';">Sign up</button>
  </div>
    <div>
   <div class="heading">
     LOGIN NOW!
